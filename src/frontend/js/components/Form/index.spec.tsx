...
describe('Field', () => {
  it('applies fieldClasses to form-field element', () => {
    const { container } = render(
      <TextField fieldClasses={['field-modifier--1', 'field-modifier--2']} />,
    );
...
describe('SelectField', () => {
  it('renders a select element', () => {
    ...
    const { container } = render(<SelectField id="language" name="language" options={options} />);
  ...
  it('renders a select element with its associated label', () => {
    ...
    const { container } = render(
      <SelectField label="Cities" id="cities" name="cities" options={options} />,
    );
